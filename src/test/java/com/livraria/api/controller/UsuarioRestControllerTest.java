...
class UsuarioRestControllerTest {
    ...
    void deveBuscarUsuarioPorIdSemExporSenha() throws Exception {
        ...
        Usuario salvo = usuarioService.salvar(new Usuario(
                "Giulia",
                "giulia@email.com",
                "senha123",
                "01001000",
    ...
    void deveAtualizarUsuarioComSucesso() throws Exception {
        ...
        mockMvc.perform(put("/api/usuarios/" + salvo.getId())
                ...
                .andExpect(jsonPath("$.nome")
                        .value("Giulia Atualizada"))
                .andExpect(jsonPath("$.email")
                        .value("giulia.novo@email.com"))
                .andExpect(jsonPath("$.senha").doesNotExist());
    ...
    void deveDeletarUsuarioComSucesso() throws Exception {
        ...
        assertTrue(
                usuarioRepository.findById(salvo.getId()).isEmpty()
        );
    }
